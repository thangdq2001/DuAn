...
public class KhachSanPhongAddDiaLog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // cancel dialog
        cancel = view.findViewById(R.id.khacSanPhongDialogCancel);
        ...
        // add data button;
        add = view.findViewById(R.id.khachSanPhongDiaLogAddData);
    ...
    public void addData(){
        ...
        KhachSanPhong ksp = new KhachSanPhong(id,loaiPhong,giaGoc,soPhong,soLuongPhong,giamGia,gia);
